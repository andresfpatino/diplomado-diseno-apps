...
<head>
    ...
    <meta name="author" content="">
     ...
     <title>Listado estudiantes | App teacher helper</title>
                        ...
                        <form id="estudiantes" class="form-horizontal" enctype="multipart/form-data" method="POST">
                          ...
                          <div class="form-group is-fileinput">
                            ...
                            <div class="input-group">
                              <input readonly="" class="form-control" name="foto" placeholder="Seleccione un archivo..." type="text">
                                <span class="input-group-btn input-group-sm">
                                  <button type="button" class="btn btn-fab btn-fab-mini">
                                    <i class="fa fa-upload" style="padding: 9px 0px 0px !important;font-size: 20px !important;color: rgb(0, 124, 168) !important;"></i>
                                  </button>
                                </span>
                            </div>
